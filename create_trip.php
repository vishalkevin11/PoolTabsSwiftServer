...
*/
 ...
 //  echo "}";
    ...
    $trip_path = isset($decoded['trip_path']) ? "'".$decoded['trip_path']."'" : "\"\"";
       ...
       // $uniqueid_val        = $unixtime
        $uniqueid_val               = isset($decoded['uniqueid']) ? "".$decoded['uniqueid']."" : $unixtime;
...
$polyline =  isset($value['polyline']) ? "'".$value['polyline']."'" : "\"\"";
 ...
 $sql  .= "INSERT INTO LatLongs (latitude, longitude, routeId, distance , duration,htmlImstruction,polyline,orderID) 
